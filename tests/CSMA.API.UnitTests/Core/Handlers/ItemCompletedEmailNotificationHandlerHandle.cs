using CSMA.API.Core.Interfaces;
using CSMA.API.Core.ProjectAggregate;
using CSMA.API.Core.ProjectAggregate.Events;
using CSMA.API.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace CSMA.API.UnitTests.Core.Handlers;
